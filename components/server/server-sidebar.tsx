    ...
    return ( 
        <div className="flex flex-col h-full text-primary w-full dark:bg-[#2b2d31] bg-[#F2F3F5]">
            ...
            <ScrollArea className="flex-1 px-3">
                        ...
                        data={[
                            {
                                label: "Text Channels",
                                type: "channel",
                                dataa: textChannels?.map((channel) => ({
                                    id: channel.id,
                                    name: channel.name,
...

                            {
                                ...
                                type: "channel",
                                dataa: audioChannels?.map((channel) => ({
                                    id: channel.id,
                                    name: channel.name,
                                    icon: iconMap[channel.type]
                                }))
...

                            {
                                ...
                                type: "channel",
                                dataa: videoChannels?.map((channel) => ({
                                    id: channel.id,
                                    name: channel.name,
                                    icon: iconMap[channel.type]
                                }))
                ...
                <Separator className="bg-zinc-200 dark:ng0zinc-700 rounded-md my-2"/>
